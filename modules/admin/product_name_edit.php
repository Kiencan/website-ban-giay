...
$title = ['pageTitle' => 'Sửa sản phẩm lớn'];
...
if (!empty($filterAll['p_name_id'])) {
    ...
    $collectionDetail = oneRaw("SELECT * FROM product_name WHERE p_name_id = $p_name_id");
    // echo '<pre>';
...
if (isPost()) {
    ...
    if (empty($errors)) {
        ...
        $updateStatus = update('product_name', $dataUpdate, "p_name_id = '$p_name_id'");
        if ($updateStatus) {
            setFlashData('smg', 'Chỉnh sửa thông tin sản phẩm lớn thành công!');
    ...
    redirect('?module=admin&action=product_name_edit&p_name_id=' . $p_name_id);
}
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid px-4 pt-3 border">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Sửa sản phẩm lớn </li>
                </ul>
            </div>

            <div class="container-fluid px-4">
                <h1 class="mt-4">Sửa sản phẩm lớn</h1>
            </div>
            ...
            <div class="container px-4">
                ...
                <div class="row d-grid gap-2 justify-content-center">
                    <input type="hidden" name="p_name_id" value="<?php echo $p_name_id ?>" />
                    <button class="btn btn-primary" type="submit">Cập nhật sản phẩm lớn</button>
