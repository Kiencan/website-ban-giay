            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="right-content">
                        ...
                        <div class="quote">
                            <i class="fa fa-quote-left"></i><p> 3H1A Store – Chất riêng đẳng cấp, khẳng định phong cách thời thượng. Từ các thương hiệu thời trang đình đám trên thế giới, chúng tôi giúp bạn tự tin hơn trong từng bước đi và tỏa sáng hơn với phong cách riêng.</p>
                        </div>
                        <p>
                ...
                <div class="col-lg-8">
                    ...
                    <form id="subscribe" action="" method="get">
                        <div class="row">
                          <div class="col-lg-5">
                            <fieldset>
                              <input name="name" type="text" id="name" placeholder="Nhập tin nhắn" required="">
                            </fieldset>
                          </div>
                          <div class="col-lg-5">
                            <fieldset>
                              <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Nhập email của bạn" required="">
                            </fieldset>
                          </div>
                          <div class="col-lg-2">
                            <fieldset>
