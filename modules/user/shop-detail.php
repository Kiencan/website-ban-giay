...
<div class="container-fluid page-header py-5">
  ...
  <ol class="breadcrumb justify-content-center mb-0">
    <li class="breadcrumb-item" style="color: rgb(227, 224, 224)">
      <a href="#">Trang chủ</a>
    </li>
    <li class="breadcrumb-item" style="color: rgb(227, 224, 224)">
      <a href="#">Sneaker</a>
      ...
      <div class="col-lg-8 col-xl-9">
        <div class="row g-4">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active rounded">
                  <img
                    ...
                    onclick="openModal('<?php echo _WEB_HOST_TEMPLATE ?>/image/giay2.jpg', document.querySelector('h4').textContent)"
                ...
                <div class="carousel-item rounded">
                  <img
                    ...
                    alt="Second slide"
                    onclick="openModal('<?php echo _WEB_HOST_TEMPLATE ?>/image/giay3.jpg')"
                    style="cursor: pointer" />
                </div>
              </div>
              <button
          ...
          <div class="col-lg-6">
            ...
            <div class="type-giay">
              <span class="select-size mt-3">Màu sắc</span>
              <div class="chon-mau">
            ...
            <div
              class="size-text mt-3"
              style="display: flex; justify-content: space-between">
              <span class="select-size">Kích thước</span>
              <span class="size-guide"><a href="#"><u>Hướng dẫn chọn size</u></a></span>
            </div>
            <div class="chon-size">
              <button class="size">1</button>
              <button class="size">2</button>
            ...
            <a
              href="#"
              class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to
              cart</a>
            <a
              href="#"
              class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i class="fa fa-phone me-2 text-primary"></i>Tư vấn hotline:
              0383083743</a>
          </div>
          <div class="col-lg-12">
            <nav>
