...
<head>
  <link rel="stylesheet" href="templates/css/chon_giay.css" />
...
<body>
  <div class="grid-container">
    ...
    <div class="content">
      <div class="cac-anh">
        <div><img src="./templates/image/giay1.jpg" width="60px" /></div>
        <div><img src="./templates/image/giay2.jpg" width="60px" /></div>
        <div><img src="./templates/image/giay3.jpg" width="60px" /></div>
        <div><img src="./templates/image/giay4.jpg" width="60px" /></div>
        <div><img src="./templates/image/giay5.jpg" width="60px" /></div>
      </div>
      <div class="anh-chinh">
        <img src="./templates/image/giay1.jpg" width="600px" />
        <div class="tl">
          <button class="btn">
        ...
        <div class="br">
          <a href="#" class="previous_round">&#8249;</a>
          <a href="#" class="next_round">&#8250;</a>
        </div>
      </div>
      <div class="thong-tin">
        <div class="ten-giay">
        ...
        <div class="size-text">
          ...
          <span class="size-guide"><a href="#"><strong>Size Guide</strong></a></span>
        </div>
        <div class="chon-size">
          ...
          <!-- <button class="size">14</button>
            <button class="size">15</button> -->
        </div>
        <div class="add_bag">
          <button>Add to Bag</button>
        </div>
        <div class="favorite">
          <button>Favorite <i class="fa fa-heart-o"></i></button>
        </div>
      </div>
    </div>
